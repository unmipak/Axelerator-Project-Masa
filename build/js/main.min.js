...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    (0, _initModals.initModals)(); // модальное окно

    var form = new _form.Form();
    window.form = form;
    form.init(); // форма

    (0, _vendor.initNewsBtns)(); // фильтры

    (0, _initAccordion.initAccordions)(); // аккордеон

    (0, _vendor.setMap)(); // карта
...
navBtn.addEventListener('click', function () {
  if (navMenu.classList.contains('header__nav--closed')) {
    ...
    _initAccordion.accordions.closeAllAccordion(navList);
  }
});
...
modal.addEventListener('click', function (evt) {
  ...
  if (!target.closest('.modal__wrapper') && !target.closest('.modal__btn-close')) {
    _initModals.modals.close('Форма обратной связи');
  }
});
var modalBtnOpen = document.querySelector('[data-open-modal]');
var modalNameInput = document.getElementById('name-modal');
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/select/custom-select":12,"./utils/ios-vh-fix":16,"./vendor":18,"./vendor/init-accordion":21}],2:[function(require,module,exports){
"use strict";
...
exports.sliderReviews = exports.sliderPrograms = exports.sliderNews = exports.sliderHero = exports.setMap = exports.initNewsBtns = void 0;
...
var sliderHero = new _swiper.default('.hero', {
  loop: true,
  slidesPerView: 1,
...
exports.sliderHero = sliderHero;
var sliderPrograms = new _swiper.default('.programs__slider', {
  loop: false,
  navigation: {
...
exports.sliderPrograms = sliderPrograms;
var sliderNews = new _swiper.default('.news__slider', {
  loop: false,
  navigation: {
...
var sliderReviews = new _swiper.default('.reviews__slider', {
  loop: false,
  navigation: {
...
var newsFilters = document.querySelector('.news__filters');
var newsBtns = newsFilters.querySelectorAll('.news__btn');
var newsSlides = document.querySelectorAll('.news__item');
var onFiltersClick = function onFiltersClick(evt) {
  var currentBtn = evt.target.closest('.news__btn');
  if (!currentBtn.classList.contains('news__btn--active')) {
    newsBtns.forEach(function (btn) {
      return btn.classList.remove('news__btn--active');
    });
...
var ZOOM_SIZE = 16;
var ICON_URL = 'img/svg/pin.svg';
var mobileBreakpoint = window.matchMedia('(max-width:768px)');
var tabletBreakpoint = window.matchMedia('(max-width:1200px)');
...
},{"./vendor/focus-visible-polyfill":20,"./vendor/leaflet/leaflet":22,"./vendor/swiper":23}],19:[function(require,module,exports){
"use strict";
...
},{"./accordions":19}],22:[function(require,module,exports){
"use strict";
